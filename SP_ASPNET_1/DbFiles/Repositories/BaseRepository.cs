...
namespace SP_ASPNET_1.DbFiles.Repositories
{
    ...
    {
        int BlogLikeCount(int blogId);
        BlogLike GetBlogLikeByBlogIDAndUserID(int blogId,string userId);
        bool IsLikedBlog(int blogId,string userId);
        double AuthorAverageLikes(ICollection<int> BlogPostIDs);

    }
    public interface IBlogPostRepository : IRepository<BlogPost>
    {
        ICollection<int> GetAuthorBlogsIds(int authorId);
    }
